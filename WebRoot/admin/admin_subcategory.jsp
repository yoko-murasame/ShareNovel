...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/js/admin/assets/css/to-do.css">
		...
		<script>
			$(function() {
				...
				new Page({
					...
					getPage: function() {
						//获取当前页数跳转
						window.location.href = "${pageContext.request.contextPath}/adminCategory.do?method=toSubCategoryPage&curPage=" + this.curPage + "&pageSize=" + this.pageAmount + "&topCatId=" + ${
							topCat.catId
						};
					}
				});
    ...
    <![endif]-->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin/admin-common.css">
	</head>
			...
			<header class="header black-bg">
				...
				<div class="top-menu">
					<ul class="nav pull-right top-menu">
						<li>
							<a class="logout" href="${pageContext.request.contextPath }/admin.do?method=adminLogout">Logout</a>
						</li>
					</ul>
				</div>
			</header>
			...
			<aside>
				<div id="sidebar" class="nav-collapse ">
					...
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu">
							<a href="javascript:;"> <i class="fa fa-cogs"></i> <span>用户管理</span>
							</a>
							<ul class="sub">
								<li>
						...
						<li class="sub-menu">
							<a href="javascript:;"> <i class="fa fa-book"></i> <span>小说管理</span>
							</a>
							<ul class="sub">
								<li>
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								...
								<li class="active">
									<a href="${pageContext.request.contextPath }/adminCategory.do?method=toSubCategoryPage&topCatId=${topCat.catId}">子分类分类管理</a>
								</li>
							</ul>
						</li>
					</ul>
      ...
      *********************************************************************************************************************************************************** -->
			...
			<section id="main-content">
				<section class="wrapper site-min-height">
					...
					<div class="row mt">
						<div class="col-lg-12">
							<p>在这里新增、修改、删除分类
								<font color="red">${topCat.catName}</font> 的子分类.</p>
						</div>
					</div>
					<div id="nav" style="width:100px;display:flex;margin:5px;justify-content:space-between;">
						<!--新增Modal button -->
						<button class="btn btn-theme03 btn-sm" data-toggle="modal" data-backdrop="true" data-target="#modalNew">新增</button>
						<!-- 删除Modal button -->
										...
										<c:forEach items="${pageModel.list }" var="cat">
											<tr>
												...
												<td>
													${topCat.catName }</td>
												<td>
													<button value="${cat.catId }" onclick="showGritterSuccess()" class="btn btn-success btn-xs">
													<i class="fa fa-check"></i>
												</button>
													<button value="${cat.catId }" onclick="showEditModal(this)" class="btn btn-primary btn-xs">
						...
						<form class="form-horizontal tasi-form" id="catNewForm">
							<div class="modal-body">
								...
								<div class="form-group has-success">
									<label class="col-sm-4 control-label col-lg-4 col-md-4" for="subCatName">请输入分类名称</label>
									<div class="col-lg-10">
										<input type="hidden" id="subCatId">
										<input type="text" name="subCatName" class="form-control" id="subCatNameId">
									</div>
								</div>
					...
					<div class="modal-content">
						...
						<form class="form-horizontal tasi-form" id="catEditForm">
							<div class="modal-body">
								...
								<div class="form-group has-success">
									<label class="col-sm-4 control-label col-lg-4 col-md-4" for="catEditName">请输入父分类名称</label>
									<div class="col-lg-10">
										<input type="text" name="catEditName" class="form-control" id="catEditNameId">
									</div>
								</div>
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
								<input type="button" id="catEditBtn" class="btn btn-primary" value="保存" />
							</div>
						</form>
					</div>
				</div>
			...
			<footer class="site-footer">
				<div class="text-center">
					2019 - 中软-码之形小组
					<a href="${pageContext.request.contextPath}/admin/admin_index.jsp#" class="go-top"> <i class="fa fa-angle-up"></i>
					</a>
				</div>
			</footer>
			<!--footer end-->
		...
		<script src="${pageContext.request.contextPath}/js/admin/assets/js/jquery-ui-1.9.2.custom.min.js"></script>
		<script src="${pageContext.request.contextPath}/js/admin/assets/js/jquery.ui.touch-punch.min.js"></script>
