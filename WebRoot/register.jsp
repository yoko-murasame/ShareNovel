		...
		<script type="text/javascript">
			...
			/*$(function() {
				$("#btmForm").click(function() {
					...
					var email = $("#email").val() + $("#email-last").val();
					console.log(email);
					var phone = $("#phone").val();
					$.ajax({
						type:"post",
						url:"user.do?method=userRegister",
						data:{
							username:username,
							password:password,
							nickname:nickname,
	...
	<body>
		<div class="container">
			<div class="row">
				...
				<div>
					<form class="form-horizontal" action="userRegister.do?method=userSave" method="post">
						<div class="form-group">
							<label for="inputusername" class="col-lg-offset-2 col-lg-2 control-label">用户名</label>
							<div class="input-group col-lg-4">
								<input type="text" class="form-control" name="username" id="username" placeholder="6-18位大小字母、符号、数字" />
								<span id="usernameTip" style="display:block;color:red"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="inputpassword" class="col-lg-offset-2 col-lg-2 control-label">密码</label>
							<div class="input-group col-lg-4">
								<input type="password" class="form-control" name="password" id="password" placeholder="6-18位大小字母、符号、数字" />
							</div>
						</div>
						<div class="form-group">
							<label for="inputcpassword" class="col-lg-offset-2 col-lg-2 control-label">确认密码</label>
							<div class="input-group col-lg-4">
								<input type="password" class="form-control" name="cpassword" id="cpassword" placeholder="再次输入密码" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="input-group col-lg-4">
								<input type="text" class="form-control" aria-label="..." name="email" id="email" placeholder="邮箱" />
						...
						<div class="form-group">
							<div class="col-lg-offset-4 col-lg-4">
								<input id="btmForm" type="submit" class="btn btn-danger btn-block" value="立即注册" />
							</div>
						</div>
					</form>
				</div>
